...
Test.test("test takeListCount", (function (param) {
        var seq = Seq.fromArray([
              1,
              2,
              3,
              4,
        ...
        var match = Seq.takeListCount(seq, 3);
        TestUtils.intEqual("count is 3", match[0], 3);
        TestUtils.seqEqual("seq is 1 2 3", Seq.fromList(match[1]), {
              hd: 1,
              tl: {
                hd: 2,
                tl: {
        ...
        var match$1 = Seq.takeListCount(seq, 10);
        TestUtils.intEqual("count is 5", match$1[0], 5);
        return TestUtils.seqEqual("seq is 1 2 3 4 5", Seq.fromList(match$1[1]), {
                    hd: 1,
                    tl: {
                      hd: 2,
                      tl: {
